	...
	<div class="row">
		...
		<form method="post" class="form-horizontal col-md-6 col-md-offset-3">
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-7">
			      <input type="password" name="password"  class="form-control" id="input2" placeholder="your password" />
			    </div>
			</div>
			...
			<div class="col-sm-7">
			  <label>
			    <input type="radio" name="type" id="optionsRadios1" value="student" checked> Student
			  	  ...
			  	  <label>
			    <input type="radio" name="type" id="optionsRadios2" value="teacher"> Teacher
			  </label>
			  <label>
			    <input type="radio" name="type" id="optionsRadios3" value="admin"> Admin
			  </label>
			</div>
			</div>
